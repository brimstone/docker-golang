...
RUN mkdir -p /freebsd/x86_64-pc-freebsd12 && cd /freebsd \
 && wget http://ftp-archive.freebsd.org/pub/FreeBSD-Archive/old-releases/amd64/12.1-RELEASE/base.txz \
 && wget http://ftp-archive.freebsd.org/pub/FreeBSD-Archive/old-releases/amd64/12.1-RELEASE/lib32.txz \
